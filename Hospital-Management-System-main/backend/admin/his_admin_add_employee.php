...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_doc']))
		{
			...
			$query="INSERT INTO his_docs (doc_fname, doc_lname, doc_number, doc_email, doc_pwd, doc_role) values(?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssss', $doc_fname, $doc_lname, $doc_number, $doc_email, $doc_pwd, $doc_role);
			$stmt->execute();
			/*
                                        ...
                                        <form method="post">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <select id="inputState" required="required" name="doc_role" class="form-control">
                                                        <option>SHU</option>
                                            ...
                                            <div class="form-group col-md-2" style="display:none">
                                                    ...
                                                    <input type="text" required="required" name="doc_number" value="<?php echo $patient_number;?>" class="form-control" id="inputZip">
                                                </div>
