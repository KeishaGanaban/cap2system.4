                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input required="required" type="text" readonly name="" value="<?php echo htmlspecialchars($row->symptoms); ?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Last Name">
                                                    </div>
