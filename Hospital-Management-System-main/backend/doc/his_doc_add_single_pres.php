<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_presc']))
		{
            ...
            $pres_pat_condition = $_POST['pres_pat_condition'];
            $pres_pat_diagnosis = $_POST['pres_pat_diagnosis'];
            //sql to insert captured values
			$query="INSERT INTO  his_prescriptions  (pres_pat_name, pres_pat_number, pres_pat_type, pres_pat_addr, pres_pat_age, pres_number, pres_pat_condition, pres_pat_diagnosis, pres_ins) VALUES(?,?,?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssssss', $pres_pat_name, $pres_pat_number, $pres_pat_type, $pres_pat_addr, $pres_pat_age, $pres_number, $pres_pat_condition, $pres_pat_diagnosis, $pres_ins);
			$stmt->execute();
			/*
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-group ">
                                                        ...
                                                        <input required="required" type="text" value="<?php echo htmlspecialchars($row->cons); ?>" name="pres_pat_condition" class="form-control" id="inputCity">
                                                </div>
                                                <hr>
                                                <div class="form-row">
                                                ...
                                                <div class="form-group col-md-2" style="display:none">
                                                 ...
                                                 <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Diagnosis</label>
                                                    <input type="text" required="required" name="pres_pat_diagnosis" class="form-control" id="inputEmail4">
                                                </div>
