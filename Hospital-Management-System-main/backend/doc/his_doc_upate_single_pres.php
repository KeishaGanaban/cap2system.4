...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_patient_presc']))
		{
			...
			$query="UPDATE   his_prescriptions  SET pres_pat_name = ?, pres_pat_type = ?, pres_pat_addr = ?, pres_pat_age = ?, pres_pat_condition = ?, pres_ins = ? WHERE pres_number = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssss', $pres_pat_name, $pres_pat_type, $pres_pat_addr, $pres_pat_age,  $pres_pat_condition, $pres_ins, $pres_number);
			$stmt->execute();
			/*
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-group ">
                                                        ...
                                                        <input required="required" type="text" value="<?php echo $row->pres_pat_condition;?>" name="pres_pat_condition" class="form-control" id="inputCity">
                                                </div>
                                                <hr>
