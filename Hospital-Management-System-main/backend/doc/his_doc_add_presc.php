                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            <tr>
                                                ...
                                                <th data-hide="phone">Patient Condition</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($row->cons); ?></td>
                                                    <td><?php echo $row->pat_age;?> Years</td>
                                                    <td><?php echo $row->pat_type;?></td>
                                                    
                                                    <td><a href="his_doc_add_single_pres.php?pat_number=<?php echo $row->pat_number;?>" class="badge badge-success"><i class="fas fa-highlighter "></i> Diagnose Patient</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
