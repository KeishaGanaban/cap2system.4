<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_presc']))
		{
			...
			$query="INSERT INTO  his_prescriptions  (pres_pat_name, pres_pat_number, pres_pat_type, pres_pat_addr, pres_pat_age, pres_number, pres_pat_condition, pres_ins) VALUES(?,?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssssss', $pres_pat_name, $pres_pat_number, $pres_pat_type, $pres_pat_addr, $pres_pat_age, $pres_number, $pres_pat_condition, $pres_ins);
			$stmt->execute();
			/*
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-group ">
                                                        ...
                                                        <input required="required" type="text" value="<?php echo $row->cons;?>" name="pres_pat_condition" class="form-control" id="inputCity">
                                                </div>
                                                <hr>
                                                <div class="form-row">
