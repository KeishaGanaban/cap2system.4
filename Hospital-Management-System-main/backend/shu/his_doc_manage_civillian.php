                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <!-- <a href="his_admin_manage_patient.php?delete=<?php echo $row->civ_id;?>" class="badge badge-danger"><i class=" mdi mdi-trash-can-outline "></i> Delete</a>-->
                                                        <a href="his_doc_view_single_civilian.php?civ_id=<?php echo $row->civ_id;?>&&pat_number=<?php echo $row->civ_number;?>" class="badge badge-success"><i class="mdi mdi-eye"></i> View</a>
                                                        <a href="his_doc_update_single_civilian.php?civ_number=<?php echo $row->civ_number;?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> Update</a>
                                                    </td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
