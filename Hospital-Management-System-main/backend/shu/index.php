...
if(isset($_POST['doc_login']))
{
    ...
    $allowed_role = 'SHU'; // <-- change this to your desired category
...
<head>
    <meta charset="utf-8" />
    <title>Doctor Login - Patient Management System</title>
                    ...
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="text-center w-75 m-auto">
                                ...
                                <p class="text-muted mb-4 mt-3">Enter your username and password to access Doctor Panel.</p>
                            </div>

                            <form method='post'>
                                <div class="form-group mb-3 text-left">
                                    <label for="doc_number">User</label>
                                    <input class="form-control" name="doc_number" type="text" id="doc_number" required placeholder="User">
                                </div>

                                <div class="form-group mb-3 text-left">
                                    <label for="password">Password</label>
                                    <input class="form-control" name="doc_pwd" type="password" id="password" required placeholder="Enter your password">
                                </div>
